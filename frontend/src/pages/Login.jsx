...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6 relative overflow-hidden font-['Inter']">
            <div className="absolute -top-20 -left-20 w-80 h-80 bg-[#00E5FF]/10 rounded-full blur-[120px]"></div>
            <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-[#FF4500]/10 rounded-full blur-[120px]"></div>
